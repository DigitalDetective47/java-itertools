...
public class ZipStrictTest {
    ...
    public void test() {
        ...
        ZipStrict<Integer> stream = new ZipStrict<Integer>(Arrays.asList(evens), Arrays.asList(odds));
    ...
    public void testDifferentSizes() {
        ...
        ZipStrict<Integer> stream = new ZipStrict<Integer>(Arrays.asList(primes), Arrays.asList(smalls));
